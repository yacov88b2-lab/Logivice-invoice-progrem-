@echo off
echo ==========================================
echo Auto-Push 4PM: Pushing to Test-Main
echo User: Jacob
echo Time: %date% %time%
echo ==========================================
echo.
...
if %CHANGES%==0 (
    ...
    echo.
    echo ==========================================
    echo Auto-Push: Nothing to push (no changes today)
    echo ==========================================
...
if "%CURRENT_BRANCH%"=="Test-Main" (
    echo.
    echo WARNING: You are on Test-Main branch directly!
    echo Please work on feature/jacob-sensos-qty branch
    echo Auto-push cancelled for safety.
    echo.
    msg * "Logivice: Auto-push CANCELLED - work on feature branch!"
    exit /b 1
)
...
git add .
git commit -m "Auto-push: %date% %time% - Jacob's Sensos updates"
...
echo Wait 1 minute, then test Sensos there.
echo ==========================================
